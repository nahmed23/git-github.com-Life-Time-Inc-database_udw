CREATE PROC [dbo].[proc_p_mart_seg_member_juniors_on_account] @current_dv_batch_id [bigint] AS
begin
...
set @wf_name = 'wf_dv_mart_seg_member_juniors_on_account'
...
select bk_hash,
  ...
  join #batch_id
    on p_mart_seg_member_juniors_on_account.dv_batch_id = #batch_id.dv_batch_id
 group by bk_hash,
       dv_load_date_time

begin tran

delete from dbo.p_mart_seg_member_juniors_on_account
 where dv_batch_id in (select dv_batch_id from #batch_id)

update p_mart_seg_member_juniors_on_account
   set dv_load_end_date_time = 'dec 31, 9999'
  from #delete
 where p_mart_seg_member_juniors_on_account.bk_hash = #delete.bk_hash
   and p_mart_seg_member_juniors_on_account.dv_load_end_date_time = #delete.dv_load_date_time
...
if object_id('tempdb..#s_mart_seg_member_juniors_on_account') is not null drop table #s_mart_seg_member_juniors_on_account
create table dbo.#s_mart_seg_member_juniors_on_account with(distribution=hash(bk_hash), location=user_db, clustered index (bk_hash)) as
select s_mart_seg_member_juniors_on_account.s_mart_seg_member_juniors_on_account_id,
       s_mart_seg_member_juniors_on_account.bk_hash,
       s_mart_seg_member_juniors_on_account.juniors_on_account_segment_id,
       s_mart_seg_member_juniors_on_account.dv_load_date_time,
       s_mart_seg_member_juniors_on_account.dv_batch_id,
       dense_rank() over (partition by s_mart_seg_member_juniors_on_account.bk_hash order by s_mart_seg_member_juniors_on_account.dv_load_date_time) ranking
  from dbo.s_mart_seg_member_juniors_on_account
  join #max_batch_id
    on s_mart_seg_member_juniors_on_account.dv_batch_id > #max_batch_id.dv_batch_id
...
if object_id('tempdb..#s_mart_seg_member_juniors_on_account_end') is not null drop table #s_mart_seg_member_juniors_on_account_end
create table dbo.#s_mart_seg_member_juniors_on_account_end with(distribution=hash(bk_hash), location=user_db, clustered index (bk_hash)) as
select s_mart_seg_member_juniors_on_account_1.s_mart_seg_member_juniors_on_account_id,
       s_mart_seg_member_juniors_on_account_1.bk_hash,
       s_mart_seg_member_juniors_on_account_1.dv_load_date_time,
       s_mart_seg_member_juniors_on_account_1.dv_batch_id,
       isnull(s_mart_seg_member_juniors_on_account_2.dv_load_date_time, 'Dec 31, 9999') dv_load_end_date_time
  from #s_mart_seg_member_juniors_on_account s_mart_seg_member_juniors_on_account_1
  left join #s_mart_seg_member_juniors_on_account s_mart_seg_member_juniors_on_account_2
    on s_mart_seg_member_juniors_on_account_1.bk_hash = s_mart_seg_member_juniors_on_account_2.bk_hash
   and s_mart_seg_member_juniors_on_account_1.ranking + 1 = s_mart_seg_member_juniors_on_account_2.ranking
...
select bk_hash,
       ...
       dv_load_date_time,
       dv_batch_id
  from #s_mart_seg_member_juniors_on_account
...
select p_mart_seg_member_juniors_on_account.p_mart_seg_member_juniors_on_account_id,
       ...
       p_mart_seg_member_juniors_on_account.s_mart_seg_member_juniors_on_account_id,
       p_mart_seg_member_juniors_on_account.dv_load_end_date_time
  from dbo.p_mart_seg_member_juniors_on_account
  join #du
    on p_mart_seg_member_juniors_on_account.bk_hash = #du.bk_hash
 where p_mart_seg_member_juniors_on_account.dv_load_end_date_time = 'Dec 31, 9999'
...
select pr1.bk_hash,
       ...
       pr1.ranking,
       pr1.juniors_on_account_segment_id,
       isnull(pr2.dv_load_date_time, 'dec 31, 9999') dv_load_end_date_time,
       isnull(s_mart_seg_member_juniors_on_account_end.s_mart_seg_member_juniors_on_account_id, isnull(p_active.s_mart_seg_member_juniors_on_account_id,-998)) s_mart_seg_member_juniors_on_account_id,
       p_active.p_mart_seg_member_juniors_on_account_id,
       case when p_active.p_mart_seg_member_juniors_on_account_id is null and pr1.ranking = 1 then 1 else 0 end dv_first_in_key_series
  from #pr pr1
  left join #pr pr2
  ...
  left join #s_mart_seg_member_juniors_on_account_end s_mart_seg_member_juniors_on_account_end
    on pr1.bk_hash = s_mart_seg_member_juniors_on_account_end.bk_hash
   and pr1.dv_load_date_time >= s_mart_seg_member_juniors_on_account_end.dv_load_date_time
   and isnull(pr2.dv_load_date_time,'dec 31, 9999') <= s_mart_seg_member_juniors_on_account_end.dv_load_end_date_time
...
select #p_new.bk_hash,
       #p_new.ranking,
       s_mart_seg_member_juniors_on_account.dummy_modified_date_time satellite_date_time,
       s_mart_seg_member_juniors_on_account.dv_batch_id
 from #p_new
 join dbo.s_mart_seg_member_juniors_on_account
   on #p_new.s_mart_seg_member_juniors_on_account_id = s_mart_seg_member_juniors_on_account.s_mart_seg_member_juniors_on_account_id
...
select #p_new.p_mart_seg_member_juniors_on_account_id,
       #p_new.bk_hash,
       #p_new.juniors_on_account_segment_id,
       #p_new.s_mart_seg_member_juniors_on_account_id,
...
begin tran
    update dbo.p_mart_seg_member_juniors_on_account
       set dv_load_end_date_time = p_new.dv_load_date_time,
           ...
           dv_update_user = @user
      from #inserts p_new
     where p_mart_seg_member_juniors_on_account.p_mart_seg_member_juniors_on_account_id = p_new.p_mart_seg_member_juniors_on_account_id
       and p_mart_seg_member_juniors_on_account.bk_hash = p_new.bk_hash
       and p_new.ranking = 1

    insert into dbo.p_mart_seg_member_juniors_on_account(
        bk_hash,
        juniors_on_account_segment_id,
        s_mart_seg_member_juniors_on_account_id,
    ...
    select p1.bk_hash,
           p1.juniors_on_account_segment_id,
           p1.s_mart_seg_member_juniors_on_account_id,
