CREATE PROC [dbo].[proc_fact_mms_sales_transaction_item_initial_load] @dv_batch_id [varchar](500),@job_group [varchar](500),@begin_extract_date_time [datetime] AS
begin
...
create table dbo.#etl_step_1 with(distribution=hash(fact_mms_sales_transaction_item_key), location=user_db) as
  ...
  from d_mms_tran_item #tran_item
  join d_mms_mms_tran #mms_tran
