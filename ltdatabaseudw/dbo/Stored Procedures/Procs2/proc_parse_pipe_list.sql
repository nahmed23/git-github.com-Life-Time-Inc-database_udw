CREATE PROC [dbo].[proc_parse_pipe_list] @item [varchar](500),@list_table [varchar](500) AS
begin
set xact_abort on
set nocount on
...
set @sql ='DECLARE @list varchar(500)'+@NewLineChar+
          ...
          drop table ' + @table_name + @NewLineChar+' create table dbo.'+@table_name + ' (item varchar(500)  null ) with (location=user_db,heap)' +@NewLineChar+
