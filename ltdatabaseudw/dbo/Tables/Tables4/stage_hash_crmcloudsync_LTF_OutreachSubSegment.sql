CREATE TABLE [dbo].[stage_hash_crmcloudsync_LTF_OutreachSubSegment] (
    [stage_hash_crmcloudsync_LTF_OutreachSubSegment_id] BIGINT         IDENTITY (1, 1) NOT NULL,
    ...
    [ltf_attributeindex]                                INT            NULL,
    [ltf_description]                                   NVARCHAR (100) NULL,
    [ltf_outreachsubsegmentid]                          VARCHAR (36)   NULL,
