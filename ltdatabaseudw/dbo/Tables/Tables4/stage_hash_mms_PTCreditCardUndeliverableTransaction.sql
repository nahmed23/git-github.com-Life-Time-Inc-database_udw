CREATE TABLE [dbo].[stage_hash_mms_PTCreditCardUndeliverableTransaction] (
    [stage_hash_mms_PTCreditCardUndeliverableTransaction_id] BIGINT          IDENTITY (1, 1) NOT NULL,
