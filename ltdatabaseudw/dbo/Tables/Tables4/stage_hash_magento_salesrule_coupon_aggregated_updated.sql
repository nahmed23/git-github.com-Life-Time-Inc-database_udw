CREATE TABLE [dbo].[stage_hash_magento_salesrule_coupon_aggregated_updated] (
    [stage_hash_magento_salesrule_coupon_aggregated_updated_id] BIGINT          IDENTITY (1, 1) NOT NULL,
