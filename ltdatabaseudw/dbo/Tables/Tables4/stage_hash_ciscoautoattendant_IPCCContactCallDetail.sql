CREATE TABLE [dbo].[stage_hash_ciscoautoattendant_IPCCContactCallDetail] (
    [stage_hash_ciscoautoattendant_IPCCContactCallDetail_id] BIGINT        IDENTITY (1, 1) NOT NULL,
