CREATE TABLE [dbo].[s_exerp_booking_recurrence] (
    [s_exerp_booking_recurrence_id] BIGINT         IDENTITY (1, 1) NOT NULL,
...
CREATE NONCLUSTERED INDEX [ix_dv_batch_id]
    ON [dbo].[s_exerp_booking_recurrence]([dv_batch_id] ASC);
