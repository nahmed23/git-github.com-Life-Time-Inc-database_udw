CREATE TABLE [dbo].[s_exacttarget_surveys] (
    [s_exacttarget_surveys_id]     BIGINT         IDENTITY (1, 1) NOT NULL,
...
GO
CREATE CLUSTERED INDEX [ci_s_exacttarget_surveys]
    ON [dbo].[s_exacttarget_surveys]([bk_hash] ASC, [s_exacttarget_surveys_id] ASC);


GO
CREATE NONCLUSTERED INDEX [ix_dv_batch_id]
    ON [dbo].[s_exacttarget_surveys]([dv_batch_id] ASC);
