CREATE TABLE [dbo].[s_crmcloudsync_invoice] (
    [s_crmcloudsync_invoice_id]            BIGINT          IDENTITY (1, 1) NOT NULL,
...
GO
CREATE CLUSTERED INDEX [ci_s_crmcloudsync_invoice]
    ON [dbo].[s_crmcloudsync_invoice]([bk_hash] ASC, [s_crmcloudsync_invoice_id] ASC);


GO
CREATE NONCLUSTERED INDEX [ix_dv_batch_id]
    ON [dbo].[s_crmcloudsync_invoice]([dv_batch_id] ASC);
