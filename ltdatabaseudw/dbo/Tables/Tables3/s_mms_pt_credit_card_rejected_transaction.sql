CREATE TABLE [dbo].[s_mms_pt_credit_card_rejected_transaction] (
    [s_mms_pt_credit_card_rejected_transaction_id] BIGINT          IDENTITY (1, 1) NOT NULL,
...
GO
CREATE CLUSTERED INDEX [ci_s_mms_pt_credit_card_rejected_transaction]
    ON [dbo].[s_mms_pt_credit_card_rejected_transaction]([bk_hash] ASC, [s_mms_pt_credit_card_rejected_transaction_id] ASC);


GO
CREATE NONCLUSTERED INDEX [ix_dv_batch_id]
    ON [dbo].[s_mms_pt_credit_card_rejected_transaction]([dv_batch_id] ASC);
