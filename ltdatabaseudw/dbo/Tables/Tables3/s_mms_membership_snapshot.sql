CREATE TABLE [dbo].[s_mms_membership_snapshot] (
    [s_mms_membership_snapshot_id]            BIGINT          IDENTITY (1, 1) NOT NULL,
...
GO
CREATE CLUSTERED INDEX [ci_s_mms_membership_snapshot]
    ON [dbo].[s_mms_membership_snapshot]([bk_hash] ASC, [s_mms_membership_snapshot_id] ASC);


GO
CREATE NONCLUSTERED INDEX [ix_dv_batch_id]
    ON [dbo].[s_mms_membership_snapshot]([dv_batch_id] ASC);
