CREATE TABLE [dbo].[l_crmcloudsync_invoice] (
    [l_crmcloudsync_invoice_id] BIGINT         IDENTITY (1, 1) NOT NULL,
...
GO
CREATE CLUSTERED INDEX [ci_l_crmcloudsync_invoice]
    ON [dbo].[l_crmcloudsync_invoice]([bk_hash] ASC, [l_crmcloudsync_invoice_id] ASC);


GO
CREATE NONCLUSTERED INDEX [ix_dv_batch_id]
    ON [dbo].[l_crmcloudsync_invoice]([dv_batch_id] ASC);
