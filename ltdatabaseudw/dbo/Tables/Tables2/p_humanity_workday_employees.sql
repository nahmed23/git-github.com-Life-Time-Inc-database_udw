CREATE TABLE [dbo].[p_humanity_workday_employees] (
    [p_humanity_workday_employees_id]      BIGINT        IDENTITY (1, 1) NOT NULL,
    ...
    [l_humanity_workday_employees_id]      BIGINT        NULL,
    [s_humanity_workday_employees_id]      BIGINT        NULL,
