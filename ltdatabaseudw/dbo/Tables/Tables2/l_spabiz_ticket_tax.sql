CREATE TABLE [dbo].[l_spabiz_ticket_tax] (
    [l_spabiz_ticket_tax_id] BIGINT          IDENTITY (1, 1) NOT NULL,
...
GO
CREATE CLUSTERED INDEX [ci_l_spabiz_ticket_tax]
    ON [dbo].[l_spabiz_ticket_tax]([bk_hash] ASC, [l_spabiz_ticket_tax_id] ASC);


GO
CREATE NONCLUSTERED INDEX [ix_dv_batch_id]
    ON [dbo].[l_spabiz_ticket_tax]([dv_batch_id] ASC);
