CREATE TABLE [dbo].[l_crmcloudsync_ltf_subscriber] (
    [l_crmcloudsync_ltf_subscriber_id] BIGINT         IDENTITY (1, 1) NOT NULL,
    ...
    [ltf_originating_opportunity_id]   VARCHAR (36)   NULL,
...
CREATE NONCLUSTERED INDEX [ix_dv_batch_id]
    ON [dbo].[l_crmcloudsync_ltf_subscriber]([dv_batch_id] ASC);
