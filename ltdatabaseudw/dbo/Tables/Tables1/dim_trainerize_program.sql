CREATE TABLE [dbo].[dim_trainerize_program] (
    [dim_trainerize_program_id]  BIGINT          IDENTITY (1, 1) NOT NULL,
...
WITH (CLUSTERED COLUMNSTORE INDEX, DISTRIBUTION = HASH([dim_trainerize_program_key]));
