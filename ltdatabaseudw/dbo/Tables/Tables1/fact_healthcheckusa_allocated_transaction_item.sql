CREATE TABLE [dbo].[fact_healthcheckusa_allocated_transaction_item] (
...
WITH (CLUSTERED COLUMNSTORE INDEX, DISTRIBUTION = HASH([fact_healthcheckusa_allocated_transaction_item_key]));
