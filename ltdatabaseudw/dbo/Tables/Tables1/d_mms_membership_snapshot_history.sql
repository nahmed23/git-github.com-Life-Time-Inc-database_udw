CREATE TABLE [dbo].[d_mms_membership_snapshot_history] (
    [d_mms_membership_snapshot_history_id]             BIGINT          IDENTITY (1, 1) NOT NULL,
    ...
    [p_mms_membership_snapshot_id]                     BIGINT          NOT NULL,
