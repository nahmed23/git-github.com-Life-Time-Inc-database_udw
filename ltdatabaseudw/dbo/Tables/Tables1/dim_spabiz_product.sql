CREATE TABLE [dbo].[dim_spabiz_product] (
    [dim_spabiz_product_id]            BIGINT          IDENTITY (1, 1) NOT NULL,
    [dim_spabiz_product_key]           CHAR (32)       NULL,
    [product_id]                       BIGINT          NULL,
    [store_number]                     BIGINT          NULL,
    [avg_cost]                         DECIMAL (26, 6) NULL,
    [back_bar]                         VARCHAR (25)    NULL,
...
WITH (HEAP, DISTRIBUTION = HASH([dim_spabiz_product_key]));
