CREATE TABLE [dbo].[d_fitmetrix_api_appointments] (
    [d_fitmetrix_api_appointments_id]     BIGINT        IDENTITY (1, 1) NOT NULL,
    [bk_hash]                             CHAR (32)     NOT NULL,
    [dim_fitmetrix_appointment_key]       CHAR (32)     NULL,
    [appointment_id]                      INT           NULL,
    [cancelled_flag]                      CHAR (1)      NULL,
    [dim_boss_reservation_key]            VARCHAR (32)  NULL,
    ...
    [p_fitmetrix_api_appointments_id]     BIGINT        NOT NULL,
