CREATE TABLE [dbo].[d_exerp_staff_usage] (
    [d_exerp_staff_usage_id]         BIGINT          IDENTITY (1, 1) NOT NULL,
    [bk_hash]                        CHAR (32)       NOT NULL,
    [staff_usage_id]                 VARCHAR (4000)  NULL,
    [booking_id]                     VARCHAR (4000)  NULL,
    [center_id]                      INT             NULL,
    [d_exerp_booking_bk_hash]        CHAR (32)       NULL,
    ...
    [p_exerp_staff_usage_id]         BIGINT          NOT NULL,
