CREATE TABLE [dbo].[fact_mms_membership_balance] (
    [fact_mms_membership_balance_id]            BIGINT          IDENTITY (1, 1) NOT NULL,
...
WITH (HEAP, DISTRIBUTION = HASH([dim_mms_membership_key]));
