CREATE TABLE [dbo].[fact_mms_sales_transaction_discount] (
    [fact_mms_sales_transaction_discount_id]               BIGINT       IDENTITY (1, 1) NOT NULL,
    [dim_club_pos_pricing_discount_key]                    CHAR (32)    NULL,
...
WITH (HEAP, DISTRIBUTION = HASH([fact_mms_sales_transaction_discount_key]));
