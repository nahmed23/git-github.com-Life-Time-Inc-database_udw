CREATE TABLE [dbo].[fact_spabiz_member_summary] (
    [fact_spabiz_member_summary_id]                       BIGINT          IDENTITY (1, 1) NOT NULL,
    ...
    [latest_service_purchase_date_time]                   DATETIME        NULL,
    [latest_service_purchase_fact_spabiz_ticket_item_key] CHAR (32)       NULL,
...
WITH (HEAP, DISTRIBUTION = HASH([dim_mms_member_key]));
