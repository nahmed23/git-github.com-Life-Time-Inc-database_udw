CREATE TABLE [dbo].[d_ec_workout_histories] (
    [d_ec_workout_histories_id]            BIGINT          IDENTITY (1, 1) NOT NULL,
    ...
    [d_ec_workout_histories_party_bk_hash] CHAR (32)       NULL,
    [d_workout_key]                        CHAR (32)       NULL,
    ...
    [p_ec_workout_histories_id]            BIGINT          NOT NULL,
