CREATE TABLE [dbo].[d_mms_membership_balance_snapshot_history] (
    [d_mms_membership_balance_snapshot_history_id] BIGINT          IDENTITY (1, 1) NOT NULL,
...
CREATE NONCLUSTERED INDEX [ix_dv_batch_id]
    ON [dbo].[d_mms_membership_balance_snapshot_history]([dv_batch_id] ASC);
