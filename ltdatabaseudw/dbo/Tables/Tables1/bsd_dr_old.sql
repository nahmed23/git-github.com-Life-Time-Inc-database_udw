CREATE TABLE [dbo].[bsd_dr_old] (
    ...
    [booking_serviced_this_period]                INT             NOT NULL,
    [booking_outstanding]                         INT             NOT NULL,
    [dim_exerp_subscription_key]                  CHAR (32)       NULL,
    [subscription_id]                             VARCHAR (4000)  NULL,
    [revenue_recognized_this_period]              DECIMAL (37, 6) NULL,
    [revenue_recognized_this_period_less_ltbucks] DECIMAL (37, 6) NULL,
    [outstanding_booking_revenue]                 DECIMAL (37, 6) NULL,
