CREATE TABLE [dbo].[d_ig_it_trn_emp_shift_cash_BD] (
    [d_ig_it_trn_emp_shift_cash_BD_id]  BIGINT          IDENTITY (1, 1) NOT NULL,
    [bk_hash]                           CHAR (32)       NOT NULL,
    [fact_cafe_employee_shift_cash_key] VARCHAR (32)    NULL,
    [bus_day_id]                        INT             NULL,
    ...
    [p_ig_it_trn_emp_shift_cash_BD_id]  BIGINT          NOT NULL,
