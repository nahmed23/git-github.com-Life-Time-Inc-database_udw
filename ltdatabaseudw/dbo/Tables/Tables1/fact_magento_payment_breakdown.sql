CREATE TABLE [dbo].[fact_magento_payment_breakdown] (
    [fact_magento_payment_breakdown_id]  BIGINT          IDENTITY (1, 1) NOT NULL,
...
WITH (CLUSTERED COLUMNSTORE INDEX, DISTRIBUTION = HASH([fact_magento_payment_breakdown_key]));
