CREATE TABLE [dbo].[d_ig_it_trn_tender_cum_BD] (
    [d_ig_it_trn_tender_cum_BD_id]    BIGINT          IDENTITY (1, 1) NOT NULL,
    [bk_hash]                         CHAR (32)       NOT NULL,
    [fact_cafe_cumulative_tender_key] VARCHAR (32)    NULL,
    [bus_day_id]                      INT             NULL,
    ...
    [net_tender_amount]               DECIMAL (26, 6) NULL,
    [received_curr_amount]            DECIMAL (26, 6) NULL,
    [tender_quantity]                 INT             NULL,
    [tip_amount]                      DECIMAL (26, 6) NULL,
    [p_ig_it_trn_tender_cum_BD_id]    BIGINT          NOT NULL,
