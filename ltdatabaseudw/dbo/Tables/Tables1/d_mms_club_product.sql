CREATE TABLE [dbo].[d_mms_club_product] (
    [d_mms_club_product_id]               BIGINT          IDENTITY (1, 1) NOT NULL,
    [bk_hash]                             CHAR (32)       NOT NULL,
    [dim_club_bridge_dim_mms_product_key] CHAR (32)       NULL,
    [club_product_id]                     INT             NULL,
    [dim_club_key]                        CHAR (32)       NULL,
    [dim_mms_product_key]                 CHAR (32)       NULL,
    [price]                               DECIMAL (26, 6) NULL,
    [sold_in_pk_flag]                     CHAR (1)        NULL,
