CREATE TABLE [dbo].[d_Humanity_employees] (
    [d_Humanity_employees_id]  BIGINT        IDENTITY (1, 1) NOT NULL,
    [bk_hash]                  CHAR (32)     NOT NULL,
    [d_humanity_employees_key] CHAR (32)     NULL,
    ...
    [p_Humanity_employees_id]  BIGINT        NOT NULL,
