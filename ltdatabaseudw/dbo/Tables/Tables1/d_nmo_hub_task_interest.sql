CREATE TABLE [dbo].[d_nmo_hub_task_interest] (
    [d_nmo_hub_task_interest_id]      BIGINT         IDENTITY (1, 1) NOT NULL,
    [bk_hash]                         CHAR (32)      NOT NULL,
    [hub_task_interest_id]            INT            NULL,
    ...
    [p_nmo_hub_task_interest_id]      BIGINT         NOT NULL,
