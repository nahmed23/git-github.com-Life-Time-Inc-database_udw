CREATE VIEW [marketing].[v_dim_magento_product_history]
AS select dim_magento_product.product_id product_id,
       ...
       dim_magento_product.color color,
       ...
       isnull(d_udwcloudsync_product_master_history.dim_reporting_hierarchy_key,dim_magento_product.default_dim_reporting_hierarchy_key) dim_reporting_hierarchy_key,
       ...
       isnull(d_udwcloudsync_product_master_history.reporting_department,'Magento') reporting_department,
       isnull(d_udwcloudsync_product_master_history.reporting_division,'Magento') reporting_division,
       ...
       isnull(d_udwcloudsync_product_master_history.reporting_sub_division,'Magento') reporting_sub_division,
...
from dim_magento_product  left join d_udwcloudsync_product_master_history
on dim_magento_product.dim_magento_product_key = d_udwcloudsync_product_master_history.dim_magento_product_key
and d_udwcloudsync_product_master_history.source_system = 'Magento';