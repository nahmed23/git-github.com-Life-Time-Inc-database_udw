CREATE VIEW [marketing].[v_dim_hybris_product_history]
AS select isnull(d_udwcloudsync_product_master_history.effective_date_time,'jan 1, 2000') effective_date_time,
       ...
       d_hybris_all_products.accept_lt_bucks_flag accept_lt_bucks_flag,
       ...
       isnull(d_udwcloudsync_product_master_history.dim_reporting_hierarchy_key,d_hybris_all_products.default_dim_reporting_hierarchy_key) dim_reporting_hierarchy_key,
       ...
       isnull(d_udwcloudsync_product_master_history.reporting_department,'E-Commerce') reporting_department,
       isnull(d_udwcloudsync_product_master_history.reporting_division,'E-Commerce') reporting_division,
       ...
       isnull(d_udwcloudsync_product_master_history.reporting_sub_division,'E-Commerce') reporting_sub_division,
...
from d_hybris_all_products  left join d_udwcloudsync_product_master_history  on d_hybris_all_products.dim_hybris_product_key = d_udwcloudsync_product_master_history.dim_hybris_product_key and d_udwcloudsync_product_master_history.source_system = 'E-Commerce - Hybris';