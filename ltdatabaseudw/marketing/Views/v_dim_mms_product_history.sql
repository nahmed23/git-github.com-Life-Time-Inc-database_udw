CREATE VIEW [marketing].[v_dim_mms_product_history]
AS select dim_mms_product.product_id product_id,
       isnull(d_udwcloudsync_product_master_history.effective_date_time,'jan 1, 2000') effective_date_time,
       ...
       isnull(d_udwcloudsync_product_master_history.dim_reporting_hierarchy_key,dim_mms_product.default_dim_reporting_hierarchy_key) dim_reporting_hierarchy_key,
       ...
       isnull(d_udwcloudsync_product_master_history.reporting_department,'MMS') reporting_department,
       isnull(d_udwcloudsync_product_master_history.reporting_division,'MMS') reporting_division,
       ...
       isnull(d_udwcloudsync_product_master_history.reporting_sub_division,'MMS') reporting_sub_division,
...
from dim_mms_product  left join d_udwcloudsync_product_master_history  on dim_mms_product.dim_mms_product_key = d_udwcloudsync_product_master_history.dim_mms_product_key and d_udwcloudsync_product_master_history.source_system = 'MMS';