CREATE VIEW [marketing].[v_dim_ig_it_trn_terminal_shift_cash_BD]
AS select d_ig_it_trn_terminal_shift_cash_BD.dim_ig_it_trn_terminal_shift_cash_BD_key dim_ig_it_trn_terminal_shift_cash_BD_key,
