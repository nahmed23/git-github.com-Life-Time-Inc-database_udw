CREATE VIEW [marketing].[v_dim_healthcheckusa_product_history]
AS select  distinct d_healthcheckusa_transactions.product_sku product_sku,
       ...
       isnull(d_udwcloudsync_product_master_history.dim_reporting_hierarchy_key,d_healthcheckusa_transactions.default_dim_reporting_hierarchy_key) dim_reporting_hierarchy_key,
       ...
       isnull(d_udwcloudsync_product_master_history.reporting_department,'HealthcheckUSA') reporting_department,
       isnull(d_udwcloudsync_product_master_history.reporting_division,'HealthcheckUSA') reporting_division,
       ...
       isnull(d_udwcloudsync_product_master_history.reporting_sub_division,'HealthcheckUSA') reporting_sub_division,
       d_udwcloudsync_product_master_history.sales_category_description sales_category_description
 from d_healthcheckusa_transactions left join d_udwcloudsync_product_master_history  on   d_healthcheckusa_transactions.product_sku = d_udwcloudsync_product_master_history.product_sku  and d_udwcloudsync_product_master_history.source_system = 'HealthCheckUSA - HealthCheckUSA';