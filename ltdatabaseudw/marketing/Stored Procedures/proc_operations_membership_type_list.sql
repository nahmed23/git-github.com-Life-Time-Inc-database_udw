CREATE PROC [marketing].[proc_operations_membership_type_list] @membership_type_list [varchar](500),@list_table [varchar](500) AS
begin
set xact_abort on
set nocount on
...
exec marketing.proc_parse_pipe_list @Item=@membership_type_list,@list_table=@list_table
