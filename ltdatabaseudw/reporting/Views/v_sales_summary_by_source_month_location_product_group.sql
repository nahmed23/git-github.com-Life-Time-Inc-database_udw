CREATE VIEW [reporting].[v_sales_summary_by_source_month_location_product_group]
AS SELECT 'Cafe' as sales_source,
...
JOIN [reporting].[v_location] Club
...
SELECT 'Spa' as sales_source,
	   ...
	   Club.area,
	   Club.club_re_open_date
  FROM [dbo].[d_spabiz_ticket_data] Ticket
  JOIN [dbo].[dim_spabiz_service] DimService
...
JOIN [reporting].[v_location] TransactionClub
