CREATE PROC [reporting].[proc_DimReportingHierarchy] @DivisionList [VARCHAR](8000),@SubdivisionList [VARCHAR](8000),@DepartmentMinDimReportingHierarchyKeyList [VARCHAR](8000),@DimReportingHierarchyKeyList [VARCHAR](8000) AS
BEGIN 
SET XACT_ABORT ON
SET NOCOUNT ON
...
----- Execution Sample
--- Exec [reporting].[proc_DimReportingHierarchy] 'All Divisions','All Subdivisions','All Departments','N/A'
-----
