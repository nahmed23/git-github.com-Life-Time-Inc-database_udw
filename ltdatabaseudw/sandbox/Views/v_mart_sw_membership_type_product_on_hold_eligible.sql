CREATE VIEW [sandbox].[v_mart_sw_membership_type_product_on_hold_eligible]
    ...
    WHERE EXISTS
          ( SELECT d_mms_membership_type_attribute.*
              ...
              WHERE d_mms_membership_type_attribute.[membership_type_id] = d_mms_membership_type.[membership_type_id]
                AND r_mms_val_membership_type_attribute.[val_membership_type_attribute_id] IN (53,54,55,56) );