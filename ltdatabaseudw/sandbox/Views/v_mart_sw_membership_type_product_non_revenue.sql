CREATE VIEW [sandbox].[v_mart_sw_membership_type_product_non_revenue]
AS SELECT [membership_type_id]           = d_mms_membership_type.[membership_type_id]
    ...
    WHERE ( d_mms_membership_type.[membership_type_id] IN (1298,6141)
         OR EXISTS
            ( SELECT d_mms_membership_type_attribute.*
                ...
                WHERE d_mms_membership_type_attribute.[membership_type_id] = d_mms_membership_type.[membership_type_id]
                  AND r_mms_val_membership_type_attribute.[val_membership_type_attribute_id] = 29 ) );