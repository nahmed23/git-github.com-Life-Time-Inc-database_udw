CREATE VIEW [sandbox].[v_mart_sw_member_attribute_card_level]
AS SELECT d_mms_member_attribute.[member_attribute_id]
   ...
   WHERE d_mms_member_attribute.[val_member_attribute_type_id] = 4
     AND (NOT d_mms_member_attribute.[effective_thru_date_time] Is Null AND d_mms_member_attribute.[effective_thru_date_time] = '2099-01-01 00:00:00.000')
