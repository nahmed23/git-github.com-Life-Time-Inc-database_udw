CREATE PROC [sandbox].[proc_mart_sw_d_udw_membership_lifetime_spend] AS  -- @min_batch_id bigint, @max_batch_id bigint AS
...
SELECT FST.[membership_id]
     ...
     , [oldest_transaction_date] = MIN(DD_Post.[calendar_date])
     , [newest_transaction_date] = MAX(DD_Post.[calendar_date])
