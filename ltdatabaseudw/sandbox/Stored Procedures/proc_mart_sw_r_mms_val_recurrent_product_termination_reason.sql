CREATE PROC [sandbox].[proc_mart_sw_r_mms_val_recurrent_product_termination_reason] @min_batch_id [bigint],@max_batch_id [bigint] AS

BEGIN

SELECT [val_recurrent_product_termination_reason_id]
     , [description]
     , [sort_order]
     , [inserted_date_time]
     , [updated_date_time]
