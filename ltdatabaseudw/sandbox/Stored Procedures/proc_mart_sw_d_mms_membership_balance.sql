CREATE PROC [sandbox].[proc_mart_sw_d_mms_membership_balance] @min_batch_id [bigint],@max_batch_id [bigint] AS

BEGIN

SELECT d_mms_membership_balance.[membership_balance_id]
  ...
  FROM ( SELECT LNK.[membership_balance_id]
           ...
           FROM [dbo].[p_mms_membership_balance] PIT
                ...
                INNER JOIN
                  ( SELECT PIT.[p_mms_membership_balance_id]
                  ...
                  ON PITU.[p_mms_membership_balance_id] = PIT.[p_mms_membership_balance_id]
...
ORDER BY d_mms_membership_balance.[dv_batch_id] ASC, d_mms_membership_balance.[dv_load_date_time] ASC, ISNULL(d_mms_membership_balance.[updated_date_time], d_mms_membership_balance.[inserted_date_time]) ASC;
