CREATE PROC [sandbox].[proc_mart_sw_d_mms_membership_type_history] @min_batch_id [bigint],@max_batch_id [bigint] AS

BEGIN

SELECT d_mms_membership_type_history.[membership_type_id]
     , d_mms_membership_type_history.[product_id]
     , LNK.[member_card_design_id]
     , d_mms_membership_type_history.[val_check_in_group_id]
     , d_mms_membership_type_history.[val_enrollment_type_id]
     , d_batch_mms_membership_type.[val_membership_type_family_status_id]
     , d_mms_membership_type_history.[val_membership_type_group_id]
     , d_batch_mms_membership_type.[val_pricing_method_id]
     , d_batch_mms_membership_type.[val_pricing_rule_id]
     , d_mms_membership_type_history.[val_restricted_group_id]
     , d_mms_membership_type_history.[val_unit_type_id]
     , d_mms_membership_type_history.[val_welcome_kit_type_id]
     , [display_name] = ISNULL(d_mms_membership_type_history.[display_name],'')
     , SAT.[assess_due_flag]
  ...
  FROM [dbo].[d_mms_membership_type_history]
       INNER JOIN
         ( SELECT PIT.[d_mms_membership_type_history_id]
         ...
         ON PITU.[d_mms_membership_type_history_id] = d_mms_membership_type_history.[d_mms_membership_type_history_id]
            AND PITU.RowRank = 1 AND PITU.RowNumber = 1
       INNER JOIN [dbo].[p_mms_membership_type] PIT
         ON PIT.[bk_hash] = d_mms_membership_type_history.[bk_hash]
            AND PIT.[p_mms_membership_type_id] = d_mms_membership_type_history.[p_mms_membership_type_id]
       ...
       LEFT OUTER JOIN
         ...
         ON l_pricing_method.[bk_hash] = d_mms_membership_type_history.[bk_hash]
       ...
       LEFT OUTER JOIN
         ...
         ON l_pricing_rule.[bk_hash] = d_mms_membership_type_history.[bk_hash]
       ...
       LEFT OUTER JOIN
         ...
         ON l_family_status.[bk_hash] = d_mms_membership_type_history.[bk_hash]
       ...
       LEFT OUTER JOIN
         ...
         ON s_min_primary_age.[bk_hash] = d_mms_membership_type_history.[bk_hash]
       ...
       LEFT OUTER JOIN
         ...
         ON s_assess_jr_member_dues_flag.[bk_hash] = d_mms_membership_type_history.[bk_hash]
            AND s_assess_jr_member_dues_flag.RowRank = 1 AND s_assess_jr_member_dues_flag.RowNumber = 1
       CROSS APPLY
         ( SELECT [val_membership_type_family_status_id] = ISNULL(d_mms_membership_type_history.[val_membership_type_family_status_id],l_family_status.[val_membership_type_family_status_id])
                , [val_pricing_method_id] = ISNULL(d_mms_membership_type_history.[val_pricing_method_id],l_pricing_method.[val_pricing_method_id])
                , [val_pricing_rule_id] = ISNULL(d_mms_membership_type_history.[val_pricing_rule_id],l_pricing_rule.[val_pricing_rule_id])
       ...
       CROSS APPLY
         ( SELECT [l_hash] = CONVERT(varchar(32), HASHBYTES('MD5', ('P%#&z$@k' + ISNULL(CONVERT(varchar, d_mms_membership_type_history.[membership_type_id]),'z#@$k%&P')
                                                                  + 'P%#&z$@k' + ISNULL(CONVERT(varchar, d_mms_membership_type_history.[product_id]),'z#@$k%&P')
                                                                  + 'P%#&z$@k' + ISNULL(CONVERT(varchar, LNK.[member_card_design_id]),'z#@$k%&P')
                                                                  + 'P%#&z$@k' + ISNULL(CONVERT(varchar, d_mms_membership_type_history.[val_check_in_group_id]),'z#@$k%&P')
                                                                  + 'P%#&z$@k' + ISNULL(CONVERT(varchar, d_mms_membership_type_history.[val_enrollment_type_id]),'z#@$k%&P')
                                                                  + 'P%#&z$@k' + ISNULL(CONVERT(varchar, d_batch_mms_membership_type.[val_membership_type_family_status_id]),'z#@$k%&P')
                                                                  + 'P%#&z$@k' + ISNULL(CONVERT(varchar, d_mms_membership_type_history.[val_membership_type_group_id]),'z#@$k%&P')
                                                                  ...
                                                                  + 'P%#&z$@k' + ISNULL(CONVERT(varchar, d_mms_membership_type_history.[val_restricted_group_id]),'z#@$k%&P')
                                                                  + 'P%#&z$@k' + ISNULL(CONVERT(varchar, d_mms_membership_type_history.[val_unit_type_id]),'z#@$k%&P')
                                                                  + 'P%#&z$@k' + ISNULL(CONVERT(varchar, d_mms_membership_type_history.[val_welcome_kit_type_id]),'z#@$k%&P'))),2)

                , [s_hash] = CONVERT(varchar(32), HASHBYTES('MD5', ('P%#&z$@k' + ISNULL(CONVERT(varchar, PIT.[membership_type_id]),'z#@$k%&P')
                                                                  + 'P%#&z$@k' + ISNULL(CONVERT(varchar, d_mms_membership_type_history.[display_name]),'z#@$k%&P')
                                                                  ...
                                                                  + 'P%#&z$@k' + ISNULL(CONVERT(varchar, d_mms_membership_type_history.[express_membership_flag]),'z#@$k%&P')
                                                                  ...
                                                                  + 'P%#&z$@k' + ISNULL(CONVERT(varchar, d_mms_membership_type_history.[short_term_membership_flag]),'z#@$k%&P')
                                                                  + 'P%#&z$@k' + ISNULL(CONVERT(varchar, d_mms_membership_type_history.[suppress_membership_card_flag]),'z#@$k%&P')
                                                                  + 'P%#&z$@k' + ISNULL(CONVERT(varchar, d_mms_membership_type_history.[waive_admin_fee_flag]),'z#@$k%&P')
  ...
  WHERE NOT d_mms_membership_type_history.[membership_type_id] Is Null
ORDER BY d_mms_membership_type_history.[dv_batch_id] ASC, d_mms_membership_type_history.[dv_load_date_time] ASC, ISNULL(SAT.[updated_date_time], SAT.[inserted_date_time]) ASC;
