CREATE PROC [sandbox].[proc_mart_sw_d_mms_mms_tran_adjustment] @min_batch_id [bigint],@max_batch_id [bigint] AS
...
SELECT d_mms_mms_tran.[mms_tran_id]
  ...
  FROM ( SELECT [mms_tran_id]          = d_mms_mms_tran.[mms_tran_id]
              ...
              , [inserted_date_time]   = SAT.[inserted_date_time]  --d_mms_mms_tran.[inserted_date_time]
           ...
           WHERE d_mms_membership.[membership_type_id] <> 134  --House Account
             AND d_mms_mms_tran.[val_tran_type_id] = 4
