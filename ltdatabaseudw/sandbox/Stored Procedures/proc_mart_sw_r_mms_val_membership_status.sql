CREATE PROC [sandbox].[proc_mart_sw_r_mms_val_membership_status] @min_batch_id [bigint],@max_batch_id [bigint] AS

BEGIN

SELECT [val_membership_status_id]
     , [description]
     , [sort_order]
  ...
  WHERE [dv_load_end_date_time] = '9999-12-31 00:00:00.000'
    AND NOT [val_membership_status_id] Is Null
