CREATE PROC [sandbox].[proc_mart_sw_r_mms_val_communication_preference_status] @min_batch_id [bigint],@max_batch_id [bigint] AS

BEGIN

SELECT [val_communication_preference_status_id]
     , [description]
     , [sort_order]
     , [inserted_date_time]
     , [updated_date_time]
