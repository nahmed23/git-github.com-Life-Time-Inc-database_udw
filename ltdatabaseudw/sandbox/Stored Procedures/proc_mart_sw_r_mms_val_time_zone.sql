CREATE PROC [sandbox].[proc_mart_sw_r_mms_val_time_zone] @min_batch_id [bigint],@max_batch_id [bigint] AS

BEGIN

SELECT [val_time_zone_id]
     , [description]
     , [sort_order]
     , [inserted_date_time]
     , [abbreviation]
  ...
  WHERE [dv_load_end_date_time] = '9999-12-31 00:00:00.000'
    AND NOT [val_time_zone_id] Is Null
