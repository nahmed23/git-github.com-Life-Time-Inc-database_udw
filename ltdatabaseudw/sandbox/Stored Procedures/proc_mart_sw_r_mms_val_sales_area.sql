CREATE PROC [sandbox].[proc_mart_sw_r_mms_val_sales_area] @min_batch_id [bigint],@max_batch_id [bigint] AS

BEGIN

SELECT [val_sales_area_id]
     , [description]
     , [sort_order]
     , [inserted_date_time]
     , [updated_date_time]
  ...
  WHERE [dv_load_end_date_time] = '9999-12-31 00:00:00.000'
    AND NOT [val_sales_area_id] Is Null
