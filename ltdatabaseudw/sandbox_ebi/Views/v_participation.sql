CREATE VIEW [sandbox_ebi].[v_participation]
AS SELECT
	booking.booking_id
...
--    ,booking.stop_dim_time_key
	  ...
	  ,part.subscription_flag
	  ,part.clipcard_flag
	  ,part.waitlist_flag
	  ,part.billable_flag
	  ,part.booking_cancelled_flag
	  ,part.participated_flag
	  ,part.participation_cancelled_flag
	  ,part.participation_cancelled_no_show_flag
