CREATE VIEW [sandbox_ebi].[v_exerp_participation] AS SELECT
	booking.booking_id
...
--      ,booking.stop_dim_time_key
  ...
  left join sandbox_ebi.v_location c on c.dim_club_key = booking.dim_club_key
  left join dbo.d_exerp_activity_group ag on ag.dim_exerp_activity_group_key = act.dim_exerp_activity_group_key
  left join sandbox_ebi.v_member mem on mem.dim_mms_member_key = part.dim_mms_member_key 
